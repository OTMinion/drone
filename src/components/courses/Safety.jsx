...
const Safety = () => {
  ...
  return (
    <div className="bg-white px-8 rounded-lg  pt-40">
      ...
      <p className="mb-4">
        Safety is paramount at Cinematic FPV, and we take it very seriously. While we want to
        provide the most stunning, dynamic and beautiful shots possible, we want to make the
        experience of getting those shots safe and comfortable for all the people involved.
      </p>
      <p className="mb-4">
        We achieve this objective in numerous ways, including researching and building our own
        drones that fit neatly into very lightweight categories while still giving high performance
        in terms of flight characteristics and filming quality. In addition, any drones we fly close
        to people will be fitted with propeller guards, keeping objects and people safe. By keeping
        drones ultra-light, small and fitted with propeller guards, we mitigate almost all damage
        and injury risk to objects and people.
      </p>
      <p className="mb-4">
        Further to this, we conduct full risk assessments and mitigate further sources of risk. We
        usually have a walkthrough of any areas to be filmed, noting any hazards and working around
        them or negating them. And when it comes to the day of filming, we give safety briefings too
        all people who will be involved on the shoot.
      </p>
      <p className="mb-4">
        In addition to this, we have many years of experience flying, working in public
        environments, and are very highly qualified. We are happy to talk through all filming
        situations and locations and work with you to ensure you get the best possible shots while
