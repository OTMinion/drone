      ...
      {showTerms && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          ...
          <div className="overflow-auto w-[90%] h-[65%] mt-6 px-8 absolute bg-white shadow-lg rounded-lg">
            ...
            <p className="mb-4">
              Welcome to [Your Website Name] ("we," "our," or "us"). By using our website, you agree to comply
            ...
            <p className="mb-4">
              We may modify these terms and conditions at any time without notice. It is your responsibility
              to review this page periodically for changes. Your continued use of our website after changes
            ...
            <ul className=" pl-5 mb-4">
              ...
              <li>
                3.2. You agree not to use our website for any harmful or illegal activities, including but not
                limited to hacking, spreading malware, or infringing on others' rights.
              </li>
            </ul>
            <h2 className="text-xl font-semibold mt-4 mb-2">4. User Accounts</h2>
            <ul className=" pl-5 mb-4">
              <li>
                4.1. Some parts of our website may require you to create an account. You are responsible for
            ...
            <ul className=" pl-5 mb-4">
              <li>
                5.1. All content, trademarks, and other intellectual property on our website are the property
                of [Your Company Name].
              </li>
              <li>5.2. You may not use our content for commercial purposes without our written consent.</li>
            </ul>
            <h2 className="text-xl font-semibold mt-4 mb-2">6. Privacy</h2>
            <ul className=" pl-5 mb-4">
              <li>
                6.1. We collect and use information in accordance with our Privacy Policy. Please review our
            ...
            <ul className=" pl-5 mb-4">
              <li>7.1. We do not guarantee that our website will be error-free or uninterrupted.</li>
              <li>
                7.2. We are not liable for any direct, indirect, incidental, special, or consequential damages
            ...
            <ul className=" pl-5 mb-4">
              <li>
                8.1. You agree to indemnify and hold us harmless from any claims, damages, or losses arising
                from your use of our website or any violation of these terms and conditions.
              </li>
            </ul>
            <h2 className="text-xl font-semibold mt-4 mb-2">9. Links to Third-Party Websites</h2>
            <ul className=" pl-5 mb-4">
              <li>
                9.1. Our website may contain links to third-party websites. These links are provided for your
                convenience, and we are not responsible for the content of these websites.
              </li>
            </ul>
            ...
            <ul className=" pl-5 mb-4">
              ...
              <li>
                10.2. Any disputes arising from or related to these terms and conditions will be subject to
            ...
            <p className="mb-4">
              ...
              [this will need to be encrypted to avoid robots/spam email], or call us on 07968 033307.
            </p>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          ...
          <div className="overflow-auto w-[90%] h-[60%] mt-6 px-8 absolute bg-white shadow-lg rounded-lg">
            ...
            <p className="mb-4">
              ...
              safeguard your personal information when you interact with our website and services.
            </p>
            <p className="mb-4">
              By using our website, you consent to the practices described in this Privacy Policy. Please read
              this policy carefully to understand our privacy practices. If you do not agree with the terms of
            ...
            <p className="mb-4">
              We use cookies and other tracking technologies to collect information about your online
              activities. You can adjust your cookie preferences in the Manage Cookies section of our website.
            </p>
            ...
            <ul className=" pl-5 mb-4">
              <li>3.1. Providing Services: To provide you with our services and to fulfill your requests.</li>
              <li>
                3.2. Communication: To communicate with you, respond to your inquiries, and send you important
                updates.
              </li>
              <li>
                3.3. Analytics: To analyse how our website is used, improve our services, and personalise your
                experience.
              </li>
              <li>
                3.4. Marketing: To send you promotional information about our products and services, subject
                to your preferences.
              </li>
              <li>
                3.5. Legal Compliance: To comply with legal obligations and protect our rights, privacy,
                safety, or property.
              </li>
            </ul>
            ...
            <ul className="pl-5 mb-4">
              ...
              <li>
                4.2. Legal Requirements: We may disclose your information when required by law or to protect
                our rights.
              </li>
              <li>
              ...
              <li>
                4.4. With Your Consent: We will share your information with third parties when you give us
            ...
            <ul className=" pl-5 mb-4">
              <li>
                5.1. Access and Update: You can access and update your personal information by contacting us
                at{" "}
                <a href="mailto:info@cinematicfpv.co.uk" className="text-blue-500 underline">
                  info@cinematicfpv.co.uk
                </a>{" "}
              ...
              <li>5.3. Cookies: You can manage your cookie preferences by referring to our Cookie Policy.</li>
            </ul>
